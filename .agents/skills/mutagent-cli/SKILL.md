...
> **Canonical source**: `mutagent-cli/.Codex/skills/mutagent-cli/SKILL.md`
...
This is the **Path 2 onboarding case**: the Skill was installed first (e.g. from a skill registry, manually, or bundled in someone else's AGENTS.md), but the CLI itself isn't installed yet. Do NOT just dump install instructions and stop -- proactively **offer to install it**.
...
| `hooks install` | Install Codex telemetry hooks | [workflows/setup.md](./workflows/setup.md) |
